export const siteConfig = {
  ...
  address: {
    street: '13035 S Post Oak Rd Suite I',
    city: 'Houston',
    state: 'TX',
    zip: '77045',
    full: '13035 S Post Oak Rd Suite I, Houston, TX 77045',
    lat: 29.6310,
    lng: -95.4438,
    googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=13035+S+Post+Oak+Rd+Suite+I+Houston+TX+77045',
    googleMapsEmbedSrc: 'https://www.google.com/maps?q=13035+S+Post+Oak+Rd+Suite+I,+Houston,+TX+77045&output=embed',
  },
  ...
  slogan: 'Southwest Houston’s Commercial Electrical Contractor. Done Right the First Time.',
  serviceAreas: ['Southwest Houston', 'Heights', 'Memorial Villages', 'Bellaire'],
  allServiceAreas: [
  ...
  coverageNote: 'Based on S Post Oak Rd · Southwest Houston · Heights · Memorial Villages daily',
  neighborhoods: 'Westbury · Meyerland · Bellaire · West U · Medical Center · Heights · Garden Oaks · Hunters Creek · Spring Valley',
  zipCodes: ['77045', '77035', '77096', '77401', '77005', '77030', '77008', '77018', '77024', '77055'],
  socials: {
    google: 'https://share.google/Qf4euLHsfdyaZ2b6U',
    thumbtack: 'https://www.thumbtack.com/tx/houston/electrical-repairs/solivance-electric/service/480274825210142737',
    yelp: 'https://www.yelp.com/biz/solivance-electric-houston',
    bizapedia: 'https://www.bizapedia.com/tx/solivance-electric-llc.html',
    instagram: 'https://www.instagram.com/solivance_electric',
  },
  testimonials: [] as { quote: string; name: string; stars: number }[],
  faqs: [
    { q: 'What areas does Solivance Electric serve?', a: 'The shop sits at 13035 S Post Oak Rd Suite I, Houston, TX 77045 — right in the middle of Southwest Houston. Daily service runs Southwest Houston (Westbury, Meyerland, Bellaire, West University, Braeswood, Sharpstown, Medical Center, Willowbend, Post Oak South, Stafford, Missouri City, Sugar Land), the Heights corridor (Houston Heights, Garden Oaks, Oak Forest, Timbergrove), and the Memorial Villages (Hunters Creek, Spring Valley, Bunker Hill, Piney Point, Hedwig). Greater Houston — Katy, Cypress, Memorial proper, Tomball, Spring — is covered on a call. Harris and Fort Bend County permits are what we pull day-in, day-out.' },
    ...
    { q: 'Do you offer warranties on commercial electrical work?', a: 'Yes. Labor carries a 1-year workmanship warranty from the date of final inspection. Manufacturer warranties pass through on equipment — Generac, Eaton, Square D, Siemens — and Solivance Electric handles the warranty claim if a unit fails inside the coverage window. Warranty terms go on the written quote before work begins.' },
    { q: 'Can you work around business hours for occupied tenant spaces?', a: 'Yes. Panel cut-overs, parking-lot re-lights, and tenant-suite work get scheduled after-hours or on weekends when the space has to stay open during the day. Overnight outages are planned in writing with the property manager and the tenant so nobody gets surprised at 6am.' },
    { q: 'Do you handle utility coordination with CenterPoint Energy?', a: 'Yes. CenterPoint cut-overs, meter releases, and temp-service requests are part of the scope on panel upgrades and new service entrances. Solivance Electric files the paperwork, coordinates the disconnect and reconnect windows, and meets the CenterPoint crew on site. Same applies to Entergy and CoServ on jobs outside the CenterPoint footprint.' },
    { q: 'What is your policy on change orders mid-project?', a: 'Change orders go in writing before the work happens — scope, material cost, labor hours, and revised completion date all on one page. Nothing gets added to the invoice that was not signed off first. If the inspector requires a code-driven change, that also goes through the same written change-order process.' },
    { q: 'Do you work with general contractors on new construction?', a: 'Yes. Ground-up warehouse, retail pad, strip center, and multi-family builds run off the GC schedule — rough-in, trim, and final inspection tied to drywall, MEP coordination, and turnover dates. One foreman stays on the job from service entrance through tenant walk.' },
    { q: 'Is there a difference between commercial and residential rates?', a: 'Yes. Commercial jobs carry different labor rates because of the scope — 3-phase switchgear, bus duct, higher-amperage feeders, and prevailing-wage requirements on some projects. Residential rates apply to single-family and small multi-family work. Every quote is fixed-fee after a site walk, so the rate structure shows up as one number, not an hourly meter.' },
    { q: 'What happens if a permit inspection fails?', a: 'Solivance Electric corrects the cited items and schedules the re-inspection at no extra cost — re-inspection fees on workmanship issues are on us, not the client. Failed inspections on our jobs run well under the Harris County and City of Houston averages; most pass the first walk.' },
  ],
};
...
export const serviceData: ServiceItem[] = [
  {
    ...
    keywords: ['commercial panel upgrade Southwest Houston', '200 amp panel upgrade Bellaire TX', 'panel replacement Houston Heights', 'electrical panel upgrade Memorial Villages'],
  },
  {
    ...
    keywords: ['commercial generator installer Southwest Houston', 'Generac installer Bellaire TX', 'whole home generator Memorial Villages', 'standby generator Houston Heights'],
  },
  {
    ...
    keywords: ['parking lot lighting contractor Southwest Houston', 'LED parking lot retrofit Bellaire TX', 'commercial pole lighting Medical Center Houston', 'property management lighting Sugar Land'],
  },
  {
    slug: 'ev-chargers',
    title: 'EV Chargers',
    ...
    keywords: ['EV charger installer Southwest Houston', 'Tesla wall connector installer Bellaire TX', 'Level 2 EV charger Houston Heights', 'commercial DCFC install Houston'],
  },
  {
    ...
    keywords: ['warehouse electrical contractor Southwest Houston', 'tilt-wall electrical Stafford TX', 'industrial electrician Missouri City TX', 'high-bay LED warehouse Sugar Land'],
  },
  {
    slug: 'pedestals',
    ...
    keywords: ['RV park pedestal Southwest Houston', 'mobile home park pedestal Stafford TX', 'temporary service pedestal Missouri City TX', '50 amp pedestal Sugar Land'],
  },
  {
    ...
    keywords: ['mobile home electrical Southwest Houston', 'manufactured home hookup Missouri City TX', 'mobile home connection Stafford TX', 'trailer electrical Sugar Land'],
  },
  {
    slug: 'home-builds',
    ...
    keywords: ['new construction electrician Southwest Houston', 'custom home electrical Bellaire TX', 'multi-family electrical contractor Houston Heights', 'home builder electrician West University TX'],
  },
  {
...
export const navLinks: NavLink[] = [
  ...
  },
  {
    ...
    href: '/locations',
    children: [
      { label: 'Southwest Houston', href: '/locations/southwest-houston', description: 'Westbury · Meyerland · Med Center · 77045.',  icon: 'map-pin' },
      { label: 'The Heights',       href: '/locations/heights',           description: 'Heights · Garden Oaks · Oak Forest.',         icon: 'map-pin' },
      { label: 'Bellaire',          href: '/locations/bellaire',          description: 'Bellaire · West University · Braeswood.',     icon: 'map-pin' },
      { label: 'Memorial Villages', href: '/locations/memorial-villages', description: 'Hunters Creek · Spring Valley · Piney Point.',icon: 'map-pin' },
      { label: 'Houston (coverage)',href: '/locations/houston',           description: 'Greater Houston · covered on a call.',         icon: 'map-pin' },
      { label: 'Katy (coverage)',   href: '/locations/katy',              description: 'West metro · I-10 corridor.',                icon: 'map-pin' },
      { label: 'Cypress (coverage)',href: '/locations/cypress',           description: 'NW Harris County · US-290 corridor.',        icon: 'map-pin' },
      { label: 'Memorial (coverage)',href: '/locations/memorial',         description: 'Memorial corridor · west of the Loop.',       icon: 'map-pin' },
    ],
    featured: {
      heading: 'Based in 77045',
      body: '13035 S Post Oak Rd Suite I — Southwest Houston, Heights, and Memorial Villages daily. Greater Houston on a call.',
