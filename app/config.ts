export const siteConfig = {
  ...
  allServiceAreas: [
    ...
    'Sugar Land, TX', 'Stafford, TX', 'Missouri City, TX', 'Magnolia, TX',
    'Conroe, TX', 'Spring, TX', 'The Woodlands, TX', 'Tomball, TX',
    'Jersey Village, TX', 'Bellaire, TX', 'West University, TX',
  ],
  coverageNote: 'Greater Houston daily · surrounding Texas on a call',
